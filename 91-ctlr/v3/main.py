...
def mem_info():
    ...
    return
print('micropython/gc loaded===================')
mem_info()
import machine
print('machine loaded ===================')
mem_info()
from machine import SD, Pin, WDT
print('SD, Pin, WDT loaded ===================')
mem_info()
import pycom
...
print('all the rest loaded ===================')
mem_info()

import socket_svr
print('socket_svr loaded ===================')
mem_info()

import shmGPSclock
print('shmGPSclock loaded ===================')
mem_info()
...
while True:
    ...
    rpi_state = socket_svr.rpi_state
    socket_svr.var_lock.release()
    socket_svr.thread_id_lock.acquire()
    thread_id = socket_svr.thread_id
    socket_svr.thread_id_lock.release()
